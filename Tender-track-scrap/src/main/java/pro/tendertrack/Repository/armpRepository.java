...
@Service
public class armpRepository {


    public void uploadFiles() {
        try {
            armpService armpService = new armpService();
            ...
            List<Appeloffre> offres = armpService.scrapeOffres(); // Assuming this method returns a list of Appeloffre objects
